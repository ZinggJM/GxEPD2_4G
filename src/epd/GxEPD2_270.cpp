...
void GxEPD2_270::writeImage_4G(const uint8_t bitmap[], uint8_t bpp, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_270::writeImagePart_4G(const uint8_t bitmap[], uint8_t bpp, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
...
void GxEPD2_270::drawImage_4G(const uint8_t bitmap[], uint8_t bpp, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_270::drawImagePart_4G(const uint8_t bitmap[], uint8_t bpp, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
                                  int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
const unsigned char GxEPD2_270::lut_20_vcom0_4G[] PROGMEM =
{
  0x00, 0x00,
...
//R21
const unsigned char GxEPD2_270::lut_21_ww_4G[] PROGMEM =
{
...
//R22H  r
const unsigned char GxEPD2_270::lut_22_bw_4G[] PROGMEM =
{
  0x40, 0x0A, 0x00, 0x00, 0x00, 0x01,
  0x90, 0x14, 0x14, 0x00, 0x00, 0x01,
...
//R23H  w
const unsigned char GxEPD2_270::lut_23_wb_4G[] PROGMEM =
{
  0x40, 0x0A, 0x00, 0x00, 0x00, 0x01,
  0x90, 0x14, 0x14, 0x00, 0x00, 0x01,
  0x00, 0x14, 0x0A, 0x00, 0x00, 0x01,
...
//R24H  b
const unsigned char GxEPD2_270::lut_24_bb_4G[] PROGMEM =
{
...
void GxEPD2_270::_Force_Init_Full()
{
  _Init_Full();
...
void GxEPD2_270::_Init_4G()
{
  _InitDisplay();
  _writeCommand(0x50); //VCOM AND DATA INTERVAL SETTING
  _writeData(0x17);    //WBmode:VBDF 17|D7 VBDW 97 VBDB 57   WBRmode:VBDF F7 VBDW 77 VBDB 37  VBDR B7
  _writeCommand(0x20);
  _writeDataPGM_sCS(lut_20_vcom0_4G, sizeof(lut_20_vcom0_4G));
  _writeCommand(0x21);
  _writeDataPGM_sCS(lut_21_ww_4G, sizeof(lut_21_ww_4G));
  _writeCommand(0x22);
  _writeDataPGM_sCS(lut_22_bw_4G, sizeof(lut_22_bw_4G));
  _writeCommand(0x23);
  _writeDataPGM_sCS(lut_23_wb_4G, sizeof(lut_23_wb_4G));
  _writeCommand(0x24);
  _writeDataPGM_sCS(lut_24_bb_4G, sizeof(lut_24_bb_4G));
  _PowerOn();
