...
class GxEPD2_290_T5D : public GxEPD2_4G_EPD
{
  public:
    // attributes
    static const uint16_t WIDTH = 128;
    static const uint16_t HEIGHT = 296;
    static const GxEPD2_4G::Panel panel = GxEPD2_4G::GDEW029T5D;
    static const bool hasColor = false;
    static const bool hasPartialUpdate = true;
    static const bool hasFastPartialUpdate = true;
    static const uint16_t power_on_time = 100; // ms, e.g. 83822us
    static const uint16_t power_off_time = 50; // ms, e.g. 39688us
    static const uint16_t full_refresh_time = 3500; // ms, e.g. 3250135us
    static const uint16_t partial_refresh_time = 800; // ms, e.g. 704324us
    // constructor
