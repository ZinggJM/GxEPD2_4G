...
void GxEPD2_420::drawImage_4G(const uint8_t bitmap[], uint8_t bpp, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_420::drawImagePart_4G(const uint8_t bitmap[], uint8_t bpp, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
                               int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_420::refresh(int16_t x, int16_t y, int16_t w, int16_t h)
{
  ...
  //else if (_refresh_mode == grey_refresh) _writeCommand(0x91); // doesn't work correctly
  _setPartialRamArea(x1, y1, w1, h1);
  if (_refresh_mode == grey_refresh) _Update_4G();
  else _Update_Part();
  if (usePartialUpdateWindow) _writeCommand(0x92); // partial out
  //else if (_refresh_mode == grey_refresh) _writeCommand(0x92); // doesn't work correctly
}
