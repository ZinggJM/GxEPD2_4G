...
void GxEPD2_213_GDEY0213B74::_writeScreenBufferArea(uint8_t command, uint8_t value, uint16_t x, uint16_t y, uint16_t w, uint16_t h)
{
...
void GxEPD2_213_GDEY0213B74::writeImage_4G(const uint8_t bitmap[], uint8_t bpp, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_213_GDEY0213B74::writeImagePart_4G(const uint8_t bitmap[], uint8_t bpp, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
                                       int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  uint16_t ppb = (bpp == 2 ? 4 : (bpp == 4 ? 2 : (bpp == 8 ? 1 : 0)));
  uint8_t mask = (bpp == 2 ? 0xC0 : (bpp == 4 ? 0xF0 : 0xFF));
...
void GxEPD2_213_GDEY0213B74::drawImage_4G(const uint8_t bitmap[], uint8_t bpp, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_213_GDEY0213B74::drawImagePart_4G(const uint8_t bitmap[], uint8_t bpp, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
                                      int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
const unsigned char GxEPD2_213_GDEY0213B74::lut_4G[] PROGMEM =
{
...
void GxEPD2_213_GDEY0213B74::_Force_Init_Full()
{
  _Init_Full();
  _refresh_mode = forced_full_refresh;
}

void GxEPD2_213_GDEY0213B74::_Init_Full()
{
  _InitDisplay();
  _PowerOn();
  _refresh_mode = full_refresh;
...
void GxEPD2_213_GDEY0213B74::_Init_4G()
{
  if (_hibernating) _reset();
  delay(10); // 10ms according to specs
...
void GxEPD2_213_GDEY0213B74::_Init_Part()
{
  _InitDisplay();
  _PowerOn();
...
void GxEPD2_213_GDEY0213B74::_Update_4G()
{
  _writeCommand(0x22);
  _writeData(0xc7);
  _writeCommand(0x20);
...
void GxEPD2_213_GDEY0213B74::drawGreyLevels()
{
  if (!_init_4G_done) _Init_4G();
  _writeCommand(0x24);
