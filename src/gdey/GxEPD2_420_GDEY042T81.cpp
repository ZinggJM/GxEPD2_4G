...
void GxEPD2_420_GDEY042T81::_writeScreenBufferArea(uint8_t command, uint8_t value, uint16_t x, uint16_t y, uint16_t w, uint16_t h)
{
...
void GxEPD2_420_GDEY042T81::writeImage_4G(const uint8_t bitmap[], uint8_t bpp, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_420_GDEY042T81::writeImagePart_4G(const uint8_t bitmap[], uint8_t bpp, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  uint16_t ppb = (bpp == 2 ? 4 : (bpp == 4 ? 2 : (bpp == 8 ? 1 : 0)));
  uint8_t mask = (bpp == 2 ? 0xC0 : (bpp == 4 ? 0xF0 : 0xFF));
...
void GxEPD2_420_GDEY042T81::drawImage_4G(const uint8_t bitmap[], uint8_t bpp, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_420_GDEY042T81::drawImagePart_4G(const uint8_t bitmap[], uint8_t bpp, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
const unsigned char GxEPD2_420_GDEY042T81::lut_4G[] PROGMEM =
{
...
void GxEPD2_420_GDEY042T81::_Force_Init_Full()
{
  _Init_Full();
  _refresh_mode = forced_full_refresh;
}
...
void GxEPD2_420_GDEY042T81::_Init_4G()
{
  if (_hibernating) _reset();
  delay(10); // 10ms according to specs
  _writeCommand(0x12);  //SWRESET
...
void GxEPD2_420_GDEY042T81::_Update_4G()
{
  _writeCommand(0x21); // Display Update Controll
...
void GxEPD2_420_GDEY042T81::drawGreyLevels()
{
  if (!_init_4G_done) _Init_4G();
  _writeCommand(0x24);
