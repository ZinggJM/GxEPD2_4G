...
class GxEPD2_420_GDEY042T81 : public GxEPD2_4G_EPD
{
  public:
    // attributes
    static const uint16_t WIDTH = 400;
    static const uint16_t HEIGHT = 300;
    static const GxEPD2_4G::Panel panel = GxEPD2_4G::GDEY042T81;
    ...
    static const uint16_t power_on_time = 100; // ms, e.g. 94998us
    static const uint16_t power_off_time = 150; // ms, e.g. 140350us
    static const uint16_t grey_refresh_time = 5500; // ms, e.g. 5403000us
    static const uint16_t full_refresh_time = 1500; // ms, e.g. 1219000us
    static const uint16_t partial_refresh_time = 400; // ms, e.g. 357000us
    // constructor
